...
public class GraphEditor extends BasicGraphEditor implements Serializable {
    ...
    public GraphEditor(String appTitle, mxGraphComponent component) {
        ...
        // Criação do elemento ACESSO UBÍCUO
        {
            ...
            molicPalette.addTemplate("Acesso Ubíquo", new ImageIcon(Objects.requireNonNull(GraphEditor.class.getClassLoader().getResource("images/molic/acessoUbicuo.png"))), acessoUbicuo);
        }
        ...
        // Criação do elemento CENA
        {
            ...
            molicPalette.addTemplate("Cena", new ImageIcon(Objects.requireNonNull(GraphEditor.class.getClassLoader().getResource("images/molic/cena.png"))), tituloCena);
        }
        ...
        // Criação do elemento CENA DE ALERTA
        {
            ...
            molicPalette.addTemplate("Cena de Alerta", new ImageIcon(Objects.requireNonNull(GraphEditor.class.getClassLoader().getResource("images/molic/cenaAlerta.png"))), cenaAlerta);
        }
        ...
        // Criação do elemento PONTO DE ABERTURA
        {
            ...
            molicPalette.addTemplate("Ponto de Abertura", new ImageIcon(Objects.requireNonNull(GraphEditor.class.getClassLoader().getResource("images/molic/pontoFim.png"))), pontoAbertura);
        }
        ...
        // Criação do elemento PONTO DE ENCERRAMENTO
        {
            ...
            molicPalette.addTemplate("Ponto de Encerramento", new ImageIcon(Objects.requireNonNull(GraphEditor.class.getClassLoader().getResource("images/molic/pontoInicio.png"))), pontoEncerramento);
        }
        ...
        // Criação do elemento PROCESSO DE SISTEMA
        {
            ...
            molicPalette.addTemplate("Processo de Sistema", new ImageIcon(Objects.requireNonNull(GraphEditor.class.getClassLoader().getResource("images/molic/processo.png"))), processoSistema);
        }
        ...
        // Criação do elemento PROCESSO COM PROGRESSO
        {
            ...
            molicPalette.addTemplate("Processo com Progresso", new ImageIcon(Objects.requireNonNull(GraphEditor.class.getClassLoader().getResource("images/molic/processoComProgresso.png"))), processoComProgresso);
